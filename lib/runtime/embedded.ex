defmodule Arlix.Runtime.Embedded do
  @moduledoc false

  # A runtime backed by the same node Arlix is running in.
  #
  ...
  def init() do
    # As we run in the Arlix node, all the necessary modules
    ...
    # as we already do it for the Arlix application globally
    # (see Arlix.Application.start/2).
...
defimpl Arlix.Runtime, for: Arlix.Runtime.Embedded do
  alias Arlix.Runtime.ErlDist
