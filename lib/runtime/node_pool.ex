defmodule Arlix.Runtime.NodePool do
  use GenServer
  ...
  ## Options
    ...
    - `:name` - The name the NodePool is locally registered as. By default, it is `Arlix.Runtime.NodePool`
  ...
  defp generate_name(state, basename) do
    new_name = :"#{Arlix.Utils.random_short_id()}-#{basename}"
