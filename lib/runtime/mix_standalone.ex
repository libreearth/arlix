defmodule Arlix.Runtime.MixStandalone do
  ...
  it with Arlix-specific modules and processes.
  ...
  * `{:error, message}` - a final message indicating failure
  ...
  def init(project_path) do
    %{ref: ref} = emitter = Arlix.Utils.Emitter.new(self())
...
defimpl Arlix.Runtime, for: Arlix.Runtime.MixStandalone do
