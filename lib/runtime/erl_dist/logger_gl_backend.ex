defmodule Arlix.Runtime.ErlDist.LoggerGLBackend do
  @moduledoc false

  # A logger backend used to forward logs to Arlix,
  ...
  defp io_proxy?(pid) do
    ...
    info[:dictionary][:"$initial_call"] == {Arlix.Evaluator.IOProxy, :init, 1}
  end
