defmodule Arlix.Runtime.Attached do
  ...
  def init(node, cookie \\ Node.get_cookie()) do
    ...
    case Node.ping(node) do
      :pong ->
        case Arlix.Runtime.ErlDist.initialize(node) do
          :ok ->
...
defimpl Arlix.Runtime, for: Arlix.Runtime.Attached do
