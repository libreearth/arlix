defmodule Arlix.Runtime.ElixirStandalone do
  defstruct [:node, :primary_pid]

  # A runtime backed by a standalone Elixir node managed by Arlix.
  #
  # Arlix is responsible for starting and terminating the node.
  # Most importantly we have to make sure the started node doesn't
  # stay in the system when the session or the entire Arlix terminates.

  import Arlix.Runtime.StandaloneInit
  ...
  it with Alix-specific modules and processes.
...
defimpl Arlix.Runtime, for: Arlix.Runtime.ElixirStandalone do
